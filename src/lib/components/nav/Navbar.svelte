    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="-mr-2 flex md:hidden">
          <!-- Mobile menu button -->
          <button on:click={handleClick} type="button" class=" bg-pink-500 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white  hover:bg-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-pink-600 focus:ring-gray-600" aria-controls="mobile-menu" aria-expanded="false">
